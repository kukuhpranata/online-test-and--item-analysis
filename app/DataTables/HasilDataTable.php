...
class HasilDataTable extends DataTable
{
    ...
    public function query(User $model)
    {
        if(Auth::user()->role_id ==2){
            ...
            $query = mJawaban::with('user', 'pertanyaan', 'ujian')->where('user_id', Auth::user()->id)
            ...
            ->where('ujian_id', $enrolled->ujian_id)->select('m_jawabans.*');
    ...
    protected function getColumns()
    {
        return [
            ...
            (['data'=> 'poin' ,'name' => 'poin' , 'title' => 'Poin','orderable' => false]),
